<template>
 <div>
   ...
   <div class="app-head">
    ...
    <my-dialog :is-show="isShowLonginDialog" @onclose="closeDialog('isShowLonginDialog')">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      onSuccesslog(data){
        this.username=data
        this.closeDialog('isShowLonginDialog')
